...
const TestSet<HookTestCase> promotion_hook_test_set{
    "game-cands-promotion-hook",
    {
        ...
        HookTestCase{
            ...
            {
                ExpectedFeatureFrame{"g7", "g8", 0, 0}
            }
        },
        // basic prom #2
        HookTestCase{
            ...
            {
                ExpectedFeatureFrame{"d2", "d1", 0, 0}
            }
        },
        ...
        HookTestCase{
            ...
            {
                ExpectedFeatureFrame{"f7", "f8", 0, 0}
            }
        },
        ...
        HookTestCase{
            ...
            {
                ExpectedFeatureFrame{"c6", "c7", 0, 0}
            }
        },
        // from 6th rank #2
        HookTestCase{
            ...
            {
                ExpectedFeatureFrame{"a3", "a2", 0, 0}
            }
        },
        // not when blocked #1
        HookTestCase{
        ...
        HookTestCase{
            ...
            {
                ExpectedFeatureFrame{"b7", "b8", 0, 0},
                ExpectedFeatureFrame{"h2", "h1", 0, 0},
            }
        }
    }
};
